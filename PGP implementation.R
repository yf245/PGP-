# This file has the PGP implementation for case study 1
...
fits_real = fits
fits_real[fits_real<0]=0

# plot the PGP fit on the actual training data
...
# plot the PGP prediction on the testing data
